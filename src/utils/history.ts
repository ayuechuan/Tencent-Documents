...
type SourceByEditorHistory<T extends EditorHistory> = T extends EditorHistory.insertRow
  ? InsertRowData
  : T extends EditorHistory.insertColumn
    ? InsertColumnData
    : // 其他操作类型与数据结构的对应关系...
      never
...
export class History {
  ...
  constructor(private readonly maximumStack = 1000) {}

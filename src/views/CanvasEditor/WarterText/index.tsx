...
export function WarterText() {
  ...
  useMount(() => {
    ...
    function rate() {
      ...
      ctx.save();
      var path = new Path2D();
      const path2 = new Path2D('M48.8820344,6.68631316 C45.4106986,3.87135976 41.298287,1.81606109 36.7978491,0.773466538 M30,0 C27.8875111,0 25.8260193,0.218345084 23.8368617,0.633698404 C17.0417632,2.05257373 11.0907689,5.77044119 6.83444861,10.936731');
    ...
    function text(x: number, y: number, options: {
      value: string,
      font: string,
      style: string
    }) {

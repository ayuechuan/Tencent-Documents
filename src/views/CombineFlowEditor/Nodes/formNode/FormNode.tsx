...
export function FormNode(props: NodeProps & {
  ...
  return (
    <div className="flow-form animate__animated animate__swing">
      <h5>公司表格上传<img style={{ width: 40 }} src={svg} alt="" /></h5>
      <div className="main">
        <Form
          labelAlign="top"
          layout="vertical"
      ...
      >
        <Space>
          <Button type='button' onClick={() => zoomIn({ duration: 800 })}>放大</Button>
          <Button type='button' onClick={() => zoomOut({ duration: 800 })}>缩小</Button>
          <Button type='button' onClick={() => zoomTo(1, { duration: 800 })}>指定</Button>
        </Space>
      </NodeToolbar>

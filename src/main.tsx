...
export class Bootstrap {
  ...
  public async mount() {
    ...
    this.reactDomRootElement.render(<App.default locales={locales}></App.default>)
  }
  ...
  public async loadLocales(): Promise<GlobalConfigProvider> {
    ...
    //  intl 项目国际化配置
    return axios.get(`${import.meta.env.BASE_URL}/locales/zh.json`).then(async () => {
  ...
  private renderConole(e: string, size?: number): string {
    return (
      void 0 === size && (size = 12),
      'display:inline-block;background-color:' + e + ';color:#fff;padding:2px 4px;font-size:' + size + 'px;'
    )
  }
  ...
  public rewriteLog(): void {
    ...
    console.log('%c数据版本%c' + '11111', this.renderConole('#e07800'), this.renderConole('rgba(69, 77, 90, 0.6)'))
    console.log('%c代码版本%c' + '22222', this.renderConole('#e07800'), this.renderConole('rgba(69, 77, 90, 0.6)'))
    console.log('%c分支版本%c' + '33333', this.renderConole('#e07800'), this.renderConole('rgba(69, 77, 90, 0.6)'))
    console.log(
